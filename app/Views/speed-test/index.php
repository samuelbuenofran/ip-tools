...
/**
 * Speed Test View
 * Professional internet speed testing interface
 */
?>
...
<div class="container py-4">
    ...
    <div class="row align-items-center mb-5">
        <div class="col-lg-8">
            <h1 class="display-4 fw-bold text-primary mb-3">
                <i class="fa-solid fa-gauge-high me-3"></i>Internet Speed Test
            </h1>
            <p class="lead mb-4">
                Professional-grade internet performance testing with real-time analytics. 
                Test your download, upload, ping, and jitter in under 30 seconds.
            </p>
            <button class="btn btn-primary btn-lg px-4" onclick="startSpeedTest()">
                <i class="fa-solid fa-play me-2"></i>Start Speed Test
            </button>
        </div>
        <div class="col-lg-4 text-center">
            <i class="fa-solid fa-tachometer-alt fa-6x text-primary opacity-75"></i>
        </div>
    </div>
        ...
        <div class="col-lg-10">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-primary text-white text-center py-4">
                    <h4 class="mb-0">
                        <i class="fa-solid fa-tachometer-alt me-2"></i>Speed Test Dashboard
                    </h4>
                </div>
                    ...
                    <div id="resultsDisplay" style="display: none;">
                        ...
                        <div class="text-center mt-4">
                            <div class="alert alert-success">
                                <h5 class="mb-2">
                                    <i class="fa-solid fa-check-circle me-2"></i>Test Complete!
                                </h5>
    ...
    <div class="card shadow-lg border-0">
        <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <i class="fa-solid fa-history me-2"></i>Recent Speed Tests
            </h5>
            <a href="<?= $view->url('speed-test/analytics') ?>" class="btn btn-light btn-sm">
                <i class="fa-solid fa-chart-line me-1"></i>View Analytics
            </a>
        </div>
        <div class="card-body">
...
<script>
    ...
    function submitResults() {
        ...
        fetch('<?= $view->url('speed-test/save') ?>', {
            method: 'POST',
            body: formData
