...
$page_title = 'Geolocation Tracker - IP Tools Suite';
$page_description = 'Crie links de rastreamento com consciência de localização que capturam endereços IP dos visitantes, localizações geográficas e informações do dispositivo com precisão milimétrica.';
