...
const translations = {
    'en': {
        ...
        'username_requirements': 'Only letters, numbers and underscore. Minimum 3 characters.',
        ...
        'dashboard_subtitle': 'Manage your tracking links and monitor activity.',
        'create_new_link': 'Create New Tracking Link',
        ...
        'no_links_created': 'No links created yet.',
        'total_links': 'Total Links',
        'back_to_dashboard': 'Back to Dashboard',
        'confirm_delete': 'Confirm Delete',
        'delete_link_warning': 'Are you sure you want to delete this link? This action cannot be undone.',
        'my_logs': 'My Logs',
        'no_logs_yet': 'No logs yet',
        'logs_will_appear': 'Logs will appear here when someone clicks on your tracking links.',
        'date_time': 'Date/Time',
        'unknown': 'Unknown',
    ...
    'pt-BR': {
        ...
        'username_requirements': 'Apenas letras, números e underscore. Mínimo 3 caracteres.',
        ...
        'dashboard_subtitle': 'Gerencie seus links de rastreamento e monitore a atividade.',
        'create_new_link': 'Criar Novo Link de Rastreamento',
        ...
        'link': 'Link:',
        'created': 'Criado:',
        'view_all_links': 'Ver Todos os Links',
        'no_links_created': 'Nenhum link criado ainda.',
        'total_links': 'Total de Links',
        'back_to_dashboard': 'Voltar ao Dashboard',
        'confirm_delete': 'Confirmar Exclusão',
        'delete_link_warning': 'Tem certeza que deseja deletar este link? Esta ação não pode ser desfeita.',
        'my_logs': 'Meus Logs',
        'no_logs_yet': 'Nenhum log ainda',
        'logs_will_appear': 'Os logs aparecerão aqui quando alguém clicar em seus links de rastreamento.',
        'date_time': 'Data/Hora',
        ...
        'expires': 'Expira',
        'never': 'Nunca',
        'create_first_link': 'Crie seu primeiro link de rastreamento no dashboard.'
